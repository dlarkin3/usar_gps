...
#    get_auto_times(rootDir,csv_file)
    ...
    log_dir = '/home/user1/PC21_Collect/Archive/HarveyLogs/APM/LOGS/'
    log_dir = '/home/user1/Projects/USAR_GPS_Study/20210714_DataR1/ApolloLogs/APM/LOGS/'
    filename = log_dir + "00000011.BIN"
    print(convert_gps_bin(filename))



'''
https://github.com/ArduPilot/ardupilot/blob/master/libraries/AP_GPS/AP_GPS.h
...
True altitude is the actual elevation above mean sea level. It is indicated altitude corrected for non-standard temperature and pressure. Height is the vertical distance above a reference point, commonly the terrain elevation. Altitude, or elevation - which is often the preferred term in geography - is the height above the sea level. So if you're standing on top of a mountain, your altitude is equal to the official height of that mountain.
